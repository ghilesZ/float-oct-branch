...
(* Few instanciations of the functor *)
(* we make only once the instanciations for all the project *)

module IdMap = Make(Id)
module SMap  = Make(String)
module FMap  = Make(struct type t=float let compare=compare end)
